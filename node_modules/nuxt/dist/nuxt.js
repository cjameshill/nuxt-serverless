...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__vue_loader_config__ = __webpack_require__(29);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_extract_text_webpack_plugin__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_extract_text_webpack_plugin__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_fs_extra__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_hash_sum__ = __webpack_require__(17);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_pify__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11_serialize_javascript__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__webpack_client_config_js__ = __webpack_require__(27);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__webpack_server_config_js__ = __webpack_require__(28);
...
var buildFiles = function () {
  var _ref2 = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee2() {
...
var generateRoutesAndFiles = function () {
  var _ref3 = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee4() {
    var _this = this;
        ...
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            templateVars = {
              ...
              plugins: this.options.plugins.map(function (p, i) {
                ...
                p.src = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__utils__["r"])(_this.srcDir, p.src);
                return { src: p.src, ssr: p.ssr !== false, name: 'plugin' + i };
              }),
              appPath: './App.vue',
              layouts: __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, this.options.layouts),
          ...
          case 6:
            ...
            layoutsFiles.forEach(function (file) {
              ...
              templateVars.layouts[name] = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__utils__["r"])(_this.srcDir, file);
            });
          ...
          case 23:
            ...
            templatesFiles = templatesFiles.map(function (file) {
              ...
              var customPath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__utils__["r"])(_this.srcDir, 'app', file);
            ...
            templatesFiles = templatesFiles.concat(this.options.build.templates.map(function (t) {
              return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({
                src: __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__utils__["r"])(_this.dir, t.src || t),
            ...
            return _context4.abrupt('return', __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all(templatesFiles.map(function () {
              var _ref4 = __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee3(_ref5) {
                var src = _ref5.src,
                    dst = _ref5.dst,
                  ...
                  while (1) {
                    switch (_context3.prev = _context3.next) {
                      case 0:
                        ...
                        _this.options.build.watch.push(src);
                      ...
                      case 3:
                        ...
                        content = template(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, templateVars, {
                          options: options || {},
                          custom: custom,
                          src: src,
                          dst: dst
                        }));
                        path = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_14__utils__["r"])(_this.buildDir, dst);
...
var debug = __webpack_require__(12)('nuxt:build');
...
var defaultsPostcss = [__webpack_require__(31)({
...
function createWebpackMiddleware() {
  ...
  clientCompiler.plugin('done', function () {
    ...
    if (fs.existsSync(filePath)) {
      ...
      _this2.appTemplate = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.template(template, {
        interpolate: /{{([\s\S]+?)}}/g
      });
    }
    _this2.watchHandler();
...
function webpackWatchAndUpdate() {
  ...
  var watchHandler = function watchHandler(err) {
    ...
    if (bundleExists && manifestExists) {
      ...
      createRenderer.call(_this3, JSON.parse(bundle), JSON.parse(manifest));
    }
  };
    ...
    serverCompiler.run(function (err, stats) {
      ...
      readFile(bundlePath, 'utf8').then(function (bundle) {
        readFile(manifestPath, 'utf8').then(function (manifest) {
          createRenderer.call(_this5, JSON.parse(bundle), JSON.parse(manifest));
          resolve();
        });
      });
    });
...
function createRenderer(bundle, manifest) {
  ...
  this.renderer = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_12_vue_server_renderer__["createBundleRenderer"])(bundle, __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({
...
function watchFiles() {
  ...
  var options = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_object_assign___default()({}, this.options.watchers.chokidar, {
    ignoreInitial: true
  });
  /* istanbul ignore next */
  var refreshFiles = __WEBPACK_IMPORTED_MODULE_4_lodash___default.a.debounce(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default()(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.mark(function _callee5() {
    return __WEBPACK_IMPORTED_MODULE_2_babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            _context5.next = 2;
            return generateRoutesAndFiles.call(_this6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify__ = __webpack_require__(4);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_json_stringify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_fs_extra__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_pify__ = __webpack_require__(10);
...
var debug = __webpack_require__(12)('nuxt:generate');
      ...
      switch (_context3.prev = _context3.next) {
        case 0:
          decorateWithPayloads = function decorateWithPayloads(routes) {
            var routeMap = __WEBPACK_IMPORTED_MODULE_6_lodash___default()(routes).map(function (route) {
              return [route, { route: route, payload: {} }];
            }).fromPairs().value();
            generateRoutes.forEach(function (route) {
              // route argument is either a string or like {route : "/my_route/1"}
              route = __WEBPACK_IMPORTED_MODULE_6_lodash___default.a.isString(route) ? route : route.route;
              if (!routeMap[route]) {
                routeMap[route] = { route: route, payload: route.payload };
              }
            });
        ...
        case 37:
          ...
          */
          routes = this.options.router.mode === 'hash' ? [{ route: '/' }] : decorateWithPayloads(this.routes);
                          ...
                          while (1) {
                            switch (_context.prev = _context.next) {
                              ...
                              case 11:
                                ...
                                /* istanbul ignore next */
                                errors.push({ type: 'unhandled', route: route, error: _context.t0 });
        ...
        case 39:
          ...
          return _context3.delegateYield(_loop(), 't2', 41);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_fs__ = __webpack_require__(40);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_fs___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_4_fs__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_lodash___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_5_lodash__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_hash_sum__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_hash_sum___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_hash_sum__);
...
var Module = function () {
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Module, [{
    ...
    value: function addVendor(vendor) {
      ...
      this.options.build.vendor = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5_lodash__["uniq"])(this.options.build.vendor.concat(vendor));
    }
  }, {
    key: 'addTemplate',
    value: function addTemplate(template) {
      ...
      var srcPath = __WEBPACK_IMPORTED_MODULE_3_path___default.a.parse(src);
      /* istanbul ignore if */
      if (!src || typeof src !== 'string' || !__WEBPACK_IMPORTED_MODULE_4_fs___default.a.existsSync(src)) {
        // eslint-disable-next-line no-console
        console.warn('[nuxt] invalid template', template);
        return;
      }
      // Generate unique and human readable dst filename
      var dst = template.fileName || __WEBPACK_IMPORTED_MODULE_3_path___default.a.basename(srcPath.dir) + '.' + srcPath.name + '.' + __WEBPACK_IMPORTED_MODULE_6_hash_sum___default()(src) + srcPath.ext;
    ...
    value: function extendBuild(fn) {
      this.options.build.extend = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utils__["chainFn"])(this.options.build.extend, fn);
    }
  }, {
    key: 'extendRoutes',
    value: function extendRoutes(fn) {
      this.options.router.extendRoutes = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_7__utils__["chainFn"])(this.options.router.extendRoutes, fn);
    }
  }, {
    key: 'requireModule',
    ...
    value: function addModule(moduleOpts) {
      ...
      var options = moduleOpts.options || {};
      ...
      try {
        if (typeof module === 'string') {
          ...
          if (module.indexOf('~') === 0 || module.indexOf('./') === 0) {
            module = __WEBPACK_IMPORTED_MODULE_3_path___default.a.join(this.options.srcDir, module.substr(1));
          }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray__ = __webpack_require__(33);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_slicedToArray__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise__ = __webpack_require__(3);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_babel_runtime_core_js_promise__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_asyncToGenerator__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_ansi_html__ = __webpack_require__(30);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_serialize_javascript__ = __webpack_require__(18);
...
var debug = __webpack_require__(12)('nuxt:render');
// force blue color
debug.color = 4;
...
var Server = function () {
  function Server(nuxt) {
    ...
    // Add Middleware
    this.nuxt.options.serverMiddleware.forEach(function (m) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5_fs_extra__ = __webpack_require__(9);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_pify__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_pify___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_6_pify__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__server__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__module__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__build__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__render__ = __webpack_require__(22);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__generate__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_serve_static__ = __webpack_require__(25);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12_serve_static___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_12_serve_static__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_path__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13_path___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_13_path__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__utils__ = __webpack_require__(2);
...
var Nuxt = function () {
  function Nuxt() {
    ...
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_classCallCheck___default()(this, Nuxt);
    ...
    this.options = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.defaultsDeep(options, defaults);
    // Env variables
    ...
    this.srcDir = typeof options.srcDir === 'string' && options.srcDir ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(this.dir, options.srcDir) : this.dir;
    this.buildDir = typeof options.build.buildNamespace === 'string' && options.build.buildNamespace ? __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(this.dir, '.nuxt', options.build.buildNamespace) : __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(this.dir, '.nuxt');
    ...
    if (__WEBPACK_IMPORTED_MODULE_5_fs_extra___default.a.existsSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(this.srcDir, 'store'))) {
      this.options.store = true;
    }
    // If app.html is defined, set the template path to the user template
    this.options.appTemplatePath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(__dirname, 'views/app.template.html');
    if (__WEBPACK_IMPORTED_MODULE_5_fs_extra___default.a.existsSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(this.srcDir, 'app.html'))) {
      this.options.appTemplatePath = __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["join"])(this.srcDir, 'app.html');
    }
    // renderer used by Vue.js (via createBundleRenderer)
    this.renderer = null;
    // For serving static/ files to /
    this.serveStatic = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_12_serve_static___default()(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(this.srcDir, 'static'), this.options.render.static));
    // For serving .nuxt/dist/ files (only when build.publicPath is not an URL)
    this.serveStaticNuxt = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_12_serve_static___default()(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(this.buildDir, 'dist'), {
      maxAge: this.dev ? 0 : '1y' // 1 year in production
    }));
    // gzip middleware for production
    if (!this.dev && this.options.render.gzip) {
      this.gzipMiddleware = __WEBPACK_IMPORTED_MODULE_6_pify___default()(__WEBPACK_IMPORTED_MODULE_4_compression___default()(this.options.render.gzip));
    }
    // Add this.Server Class
    this.Server = __WEBPACK_IMPORTED_MODULE_7__server__["a" /* default */];
    // Add this.build
    __WEBPACK_IMPORTED_MODULE_9__build__["a" /* options */].call(this); // Add build options
    this.build = __WEBPACK_IMPORTED_MODULE_9__build__["b" /* build */].bind(this);
    // Error template
    this.errorTemplate = __WEBPACK_IMPORTED_MODULE_3_lodash___default.a.template(__WEBPACK_IMPORTED_MODULE_5_fs_extra___default.a.readFileSync(__webpack_require__.i(__WEBPACK_IMPORTED_MODULE_13_path__["resolve"])(__dirname, 'views', 'error.html'), 'utf8'), {
      interpolate: /{{([\s\S]+?)}}/g
    });
    // Add this.render and this.renderRoute
    this.render = __WEBPACK_IMPORTED_MODULE_10__render__["a" /* render */].bind(this);
    this.renderRoute = __WEBPACK_IMPORTED_MODULE_10__render__["b" /* renderRoute */].bind(this);
    this.renderAndGetWindow = __WEBPACK_IMPORTED_MODULE_10__render__["c" /* renderAndGetWindow */].bind(this);
    // Add this.generate
    this.generate = __WEBPACK_IMPORTED_MODULE_11__generate__["a" /* default */].bind(this);
    // Add this.utils (tests purpose)
    this.utils = __WEBPACK_IMPORTED_MODULE_14__utils__;
    // Add module integration
    this.module = new __WEBPACK_IMPORTED_MODULE_8__module__["a" /* default */](this);
    // Install all modules in sequence and then return `this` instance
    return __WEBPACK_IMPORTED_MODULE_14__utils__["sequence"](options.modules, this.module.addModule.bind(this.module)).then(function () {
      return _this;
  ...
  __WEBPACK_IMPORTED_MODULE_2_babel_runtime_helpers_createClass___default()(Nuxt, [{
    key: 'close',
